...
export default function AddUser() {
    ...
    const handleSubmit= async (e)=>{
        ...
        const post =await axios.post("http://localhost:9090/user",user)
        navigate("/")
            ...
            <div className='row'>
                <div className='col-md-6 offset-md-3 border rounded p-4 mt-2 shadow'>
                    ...
                    <div className='mb-3'>
                        ...
                        <input type="email" required className='form-control' placeholder='Enter your e-mail address' name='email' value={email} onChange={(e)=>onInputChange(e)}></input>
                    </div>
